...
class StartMenu:
    def __init__(self, screen):
        ...
        self.background_image = pygame.image.load_extended("assets/kok.png").convert_alpha()
                    ...
                    for button in self.buttons:
                        if button.is_clicked(event.pos):
                            if button.text == "Mulai":
                                ...
                                MUSIC = ["assets/audio/City sound effect 1 - downtown.mp3",
                                         "assets/audio/Mini Metro - 02 One Week.ogg",
                                         "assets/audio/y2mate.com - SUARA AMBULANCE darurat mp3.mp3"]
                                ...
                                PASSENGER_ICON = pygame.image.load("assets/icons/soul.png").convert_alpha()
                                ...
                                RIVERS = [pygame.image.load("assets/maps/backgourdn.png").convert_alpha(),
                                    ...
                                    pygame.image.load(
                                    "assets/maps/backgourdn.png").convert_alpha(),
                                    pygame.image.load("assets/maps/backgourdn.png").convert_alpha()]

                                ICONS = [pygame.image.load("assets/icons/heli.png").convert_alpha(),
                                         pygame.image.load(
                                    "assets/icons/road.png").convert_alpha(),
                                    pygame.image.load(
                                    "assets/icons/ambulan-3.png").convert_alpha(),
